...
function AdminCalendarComp({ adminRequestEvents, events }) {
  ...
  async function updateData() {
    return adminRequestEvents();
  }
  const closeDay = () => {
    setModalDayEvent(false);
    updateData();
  };
  const closeEvent = () => {
